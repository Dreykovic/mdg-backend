...
export const InventorySchemas = {
  ...
  bulkStockMovement: z.object({
    movements: z
      .array(z.lazy((): z.ZodTypeAny => InventorySchemas.stockMovement))
...
export type InventoryMetadata = z.infer<
  typeof InventorySchemas.inventoryMetadata
>;
export type InventoryUpdateData = z.infer<
  typeof InventorySchemas.inventoryUpdate
>;
export type StockMovementData = z.infer<typeof InventorySchemas.stockMovement>;
export type WarehouseData = z.infer<typeof InventorySchemas.warehouse>;
export type InventoryReservationData = z.infer<
  typeof InventorySchemas.inventoryReservation
>;
export type BulkStockMovementData = z.infer<
  typeof InventorySchemas.bulkStockMovement
>;
export type StockAdjustmentData = z.infer<
  typeof InventorySchemas.stockAdjustment
>;
export type InventoryFiltersData = z.infer<
  typeof InventorySchemas.inventoryFilters
>;
export type MovementFiltersData = z.infer<
  typeof InventorySchemas.movementFilters
>;
export type InventorySchemasType = typeof InventorySchemas;
