...
import adminAuthModule from '@/modules/api/adminAuth/adminAuth.module'; // Admin authentication module
import conversionModule from '@/modules/api/conversion/conversion.module';
import filesModule from '@/modules/api/files/files.module'; // File handling module
import catalogModule from '@/modules/api/catalog/catalog.module'; // Catalog management module
import express from 'express'; // Express router to define API routes
import stockModule from '@/modules/api/stock/stock.module';
